 ...
 * 22.06.2010
 */
function PolygonCreator(map){this.map=map;this.pen=new Pen(this.map);var thisOjb=this;this.event=google.maps.event.addListener(thisOjb.map,'click',function(event){thisOjb.pen.draw(event.latLng);});
...
this.getData=function(){
	if(this.polygon!=null){
		...
		paths.getAt(0).forEach(function(value,index){
			data+="{\"__type\":\"GeoPoint\",\"latitude\":" + value.lat() + ",\"longitude\":" + value.lng()+"},";
		});
		data = data.slice(0, - 1)
		return data += "]";
	}
